...
CREATE UNIQUE INDEX `skill_registry_skill_code_unique` ON `skill_registry` (`skill_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_registry_org_status` ON `skill_registry` (`organization_id`,`lifecycle_status`);
--> statement-breakpoint
CREATE INDEX `idx_skill_registry_org_agent` ON `skill_registry` (`organization_id`,`agent_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_versions_version_code_unique` ON `skill_versions` (`version_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_versions_org_skill` ON `skill_versions` (`organization_id`,`skill_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_provenance_provenance_code_unique` ON `skill_provenance` (`provenance_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_provenance_org_skill` ON `skill_provenance` (`organization_id`,`skill_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_change_proposals_proposal_code_unique` ON `skill_change_proposals` (`proposal_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_change_proposals_org_status` ON `skill_change_proposals` (`organization_id`,`status`);
--> statement-breakpoint
CREATE INDEX `idx_skill_change_proposals_org_skill` ON `skill_change_proposals` (`organization_id`,`skill_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_validation_runs_validation_code_unique` ON `skill_validation_runs` (`validation_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_validation_org_proposal` ON `skill_validation_runs` (`organization_id`,`proposal_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_approvals_approval_code_unique` ON `skill_approvals` (`approval_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_approvals_org_proposal` ON `skill_approvals` (`organization_id`,`proposal_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_deployments_deployment_code_unique` ON `skill_deployments` (`deployment_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_deployments_org_skill_status` ON `skill_deployments` (`organization_id`,`skill_code`,`status`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_performance_reviews_review_code_unique` ON `skill_performance_reviews` (`review_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_performance_org_skill` ON `skill_performance_reviews` (`organization_id`,`skill_code`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `skill_rollbacks_rollback_code_unique` ON `skill_rollbacks` (`rollback_code`);
--> statement-breakpoint
CREATE INDEX `idx_skill_rollbacks_org_skill` ON `skill_rollbacks` (`organization_id`,`skill_code`);