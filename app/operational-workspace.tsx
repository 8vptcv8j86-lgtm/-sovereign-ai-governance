...
const views: Record<string, View> = {
  ...
  "Privacy risk assessment": {
    ...
    intro:
      "Assess potential harm to individuals, likelihood, severity, existing controls and additional treatment before deciding whether a DPIA or escalation is required.",
    endpoint: "/api/privacy-governance",
    ...
    fields: [
      ...
      f("jurisdiction", "Jurisdiction"),
      f("owner", "Risk owner"),
      f("evidenceRefs", "Risk evidence references", "textarea"),
      f("nextReview", "Next review", "date"),
    ],
    columns: ["entity", "recordCode", "systemCode", "state", "jurisdiction", "owner", "nextReview"],
  },
